...
export const Hero = () => {
  return (
    <div className="grid lg:grid-cols-1 gap-y-4 lg:gap-x-8 text-white">
      ...
      <div className="relative hidden bg-primary h-[280px] lg:h-[320px] xl:h-[360px] w-full rounded-[10px]">
        <img
          src={HeroSecondImage}
          alt="Hero 2"
          className="w-full h-full object-cover object-bottom"
